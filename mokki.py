AGENT_NAME                  =       "mokki"
TEAM_NAME                   =       "Just Li Han"

    
# These are algorithm parameters. You need to change this
DELTA                       =      0.3              #   How much should the epsilon shift by in every game
LR                          =      0.2            #   This is the learning rate. High learning rate means faster learning"                     
GAMMA                       =      0.2             #   gamma = discount factor. High gamma value means focus on future rewards "
...
TAKE_DAMAGE                 =      -10     
EARN_AMMO                   =      3
COLLIDE_WITH_WALLS          =      -100000
DAMAGE_ITSELF               =      -100000        
NO_DESTRUCTION              =      -5                 
NO_KILL                     =      -3             
PLACING_BOMBS_WITH_NO_AMMO  =      -100000
BOMB_IN_RANGE               =      0
PLACING_BOMB_ON_TOP_OF_BOMB =      -100000
EXIST_PENALTY               =      -100000
...
GUIDANCE                    =       0.5                         # 1 means the agent copies exactly as the coach. 0 means that the agent makes random moves Should be between 1 and 0
